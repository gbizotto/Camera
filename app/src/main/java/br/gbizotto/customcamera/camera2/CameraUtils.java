...
public final class CameraUtils {
     ...
     */
    public static void configureTransform(int viewWidth, int viewHeight) {
    ...
    private static void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                switch (displayRotation) {
                    ...
                    case Surface.ROTATION_270:
                        ...
                        break;
                    default:
                        Log.e(CameraUtils.class.getSimpleName(), "Display rotation is invalid: " + displayRotation);
                }
            ...
            ErrorDialog.newInstance(mContext.getString(R.string.camera_error))
                    .show(mActivity.getFragmentManager(), ErrorDialog.FRAGMENT_DIALOG);
        }
    }
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            ...
            Log.e(CameraUtils.class.getSimpleName(), "Couldn't find any suitable preview size");
            return choices[0];
        }
    }
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    Log.v(CameraUtils.class.getSimpleName(), "Saved: " + mFile);
                    Log.d(CameraUtils.class.getSimpleName(), mFile.toString());
                    unlockFocus();
                }
            };
...
//                    }
     ...
     */
    public static void lockFocus(Context context, Activity activity) {
        mContext = context;
        mActivity = activity;
